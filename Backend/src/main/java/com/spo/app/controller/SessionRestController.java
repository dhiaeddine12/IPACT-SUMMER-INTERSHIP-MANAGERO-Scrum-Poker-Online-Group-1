...
public class SessionRestController {
    ...
    @RequestMapping("/Pourcentage/{id_Projet}")
    public Float  Pourcentage_Avancement (@PathVariable("id_Projet") String id_projet) {
        return kpiService.Pourcentage_avancement(id_projet);
    }
}
